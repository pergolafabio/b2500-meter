...
class CTEmulator:
    def __init__(self, device_type="HMG-50", battery_mac="001122334455", ct_mac="98a14a8c75ee", ct_type="HME-3", poll_interval=1, discovery_battery_macs=None, dedupe_time_window=10):
